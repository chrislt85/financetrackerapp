...
export { default as ProfileLocation } from './profile-location';
export { default as SettingButton } from './setting-button';
export { default as SettingOption } from './setting-option';
export { default as SettingInput } from './setting-input';